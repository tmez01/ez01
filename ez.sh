...
echo -b "AUTHOR    : T͜͡M乄EZ $green " |lolcat
echo -b "ASSOCIATE : My TEAM - Riza Hidayat $green " | lolcat
...
sleep 1
echo -b $green"[#]> MR-T͜͡M乄EZ On Your System" |lolcat

echo -b $green"[#]> See you Again SCRIPTKIDDIES😎 :)..." |lolcat
figlet T͜͡M乄EZ | lolcat
sleep 1
exit
}
